...
public partial class WeaponShotgun : BaseWeapon, IMagazine
{
    [Export]
    ...
    public override void _Ready()
    {
        ...
        _pelletCount = (int)Stats.Additional["PelletCount"];
    }
    ...
    protected override void Attack()
    {
        ...
        for (var i = 0; i < _pelletCount; i++)
        {
            ...
            var bloom = (float)GD.Randfn(rotation, _bloomCoefficient) + randomRotation;
