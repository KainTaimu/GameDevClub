...
public partial class EnemyCollisionSolver : Node
{
    ...
    public override void _Ready()
    {
        ...
        var windowSize = viewport.GetVisibleRect().Size.X * 2.5f;
        var finalSize = new Vector2(windowSize, windowSize);
        _grid = new CenteredMovingUniformGrid<(Vector2, int)>(GridSize, finalSize);
    ...
    private void ApplyCollisions()
    {
        ...
        {
            _entities.UpdateComponent(id, new PositionComponent(pos, true));
        }
    }
