...
public partial class Crosshair : Node2D
{
    ...
    public static Crosshair? Instance
    {
        ...
        private set
        {
            ...
            // {
            //     Logger.LogDebug("Crosshair instance replaced");
            //     field.CallDeferred(Node.MethodName.QueueFree);
            // }
            field =
                value;
        }
    ...
    private float GetAngleFromPlayer()
    {
        ...
        var crosshairPos = CrosshairSprite.GlobalPosition * Viewport.GetScreenTransform();
